    ...
    <div className={`fixed inset-0 z-50 bg-[#0b1f3d]/50 backdrop-blur-sm p-4 ${show ? 'flex' : 'hidden'} items-center justify-center transition-all`}>
      <div className="bg-surface-container-lowest rounded-xl shadow-xl w-full max-w-[560px] overflow-hidden flex flex-col">
        <div className="p-space-lg flex items-start justify-between bg-surface-container-low">
          <div className="flex items-center gap-space-sm">
            ...
            <div className="flex flex-col">
              <h3 className="font-headline-sm text-headline-sm text-on-surface" id="modal-title">Import Data Pegawai</h3>
        ...
        <div className="p-space-lg flex flex-col gap-space-md">
          <div className="w-full rounded-xl bg-surface-container-low p-space-xl flex flex-col items-center justify-center text-center cursor-pointer hover:bg-surface-container transition-colors group">
            ...
            <p className="font-body-md-medium text-body-md-medium text-on-surface">
              Tarik file Excel ke sini atau <span className="text-secondary hover:underline font-body-md-medium text-body-md-medium">klik untuk memilih file</span>
            </p>
          ...
          <div className="p-space-md rounded-lg bg-blue-50 text-on-surface flex flex-col gap-space-xs">
            <div className="flex items-center gap-space-xs text-secondary font-headline-sm text-headline-sm">
              <span className="material-symbols-outlined text-[18px]">info</span>
                <span className="font-body-md-medium text-body-md-medium text-secondary">Ketentuan Kolom Wajib:</span>
            </div>
            ...
            <div className="mt-1 pt-2 flex items-center justify-between font-body-sm text-body-sm">
        ...
        <div className="p-space-md bg-surface-container-low flex items-center justify-end gap-space-xs">
          <button
            onClick={onClose}
            className="h-10 px-space-md rounded-lg bg-surface-container-lowest hover:bg-surface-container text-on-surface-variant font-body-md-medium text-body-md-medium transition-colors cursor-pointer"
            type="button"
          >
            Batal
          </button>
          <button
            className="h-10 px-space-lg rounded-lg bg-primary-container hover:bg-[#132c54] text-on-primary font-body-md-medium text-body-md-medium flex items-center gap-space-xs transition-colors shadow-sm cursor-pointer"
            type="button"
          >
