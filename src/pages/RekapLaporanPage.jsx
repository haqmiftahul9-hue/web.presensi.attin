      ...
      <div className="p-space-lg md:p-space-xl flex flex-col gap-space-lg max-w-[1600px] mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-space-md">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-space-xs">
              ...
              <h1 className="font-headline-lg font-headline-lg text-primary tracking-tight">Rekap & Laporan</h1>
            </div>
            <p className="font-body-md font-body-md text-on-surface-variant">Analisis komprehensif kehadiran, kepatuhan jam kerja, dan ekspor laporan berkala seluruh unit sekolah.</p>
          </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl p-space-md shadow-sm flex flex-col xl:flex-row xl:items-center xl:justify-between gap-space-md">
          <div className="flex flex-wrap items-center gap-space-sm">
            ...
            <div className="relative flex items-center bg-surface-container rounded-lg px-3 py-2 cursor-pointer hover:bg-surface-container-low transition-colors">
              ...
              <span className="font-body-md-medium font-body-md-medium text-on-surface">01 Sep 2026 – 15 Sep 2026</span>
            ...
            <div className="relative flex items-center bg-surface-container rounded-lg px-3 py-2 cursor-pointer hover:bg-surface-container-low transition-colors">
              ...
              <span className="font-body-md-medium font-body-md-medium text-on-surface">Semua Unit ({state.units.length} Unit)</span>
          ...
          <div className="flex items-center gap-space-xs flex-wrap">
            ...
            <button className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-primary-container text-on-primary font-label-md font-label-md hover:bg-primary transition-colors cursor-pointer" type="button">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-space-lg shadow-sm flex flex-col gap-space-lg">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-space-md">
            <div className="flex flex-col gap-0.5">
              <div className="flex items-center gap-space-xs">
                <h2 className="font-headline-sm font-headline-sm text-primary">Tren Kehadiran & Kepatuhan Jam Kerja</h2>
                <span className="px-2 py-0.5 rounded-full bg-secondary-fixed text-on-secondary-fixed font-label-sm font-label-sm">94.2% Rata-rata</span>
              </div>
              <span className="font-body-sm font-body-sm text-on-surface-variant">Periode 1–15 September 2026 (Seluruh Jenjang Terdaftar)</span>
            </div>
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-sm bg-secondary-container"></span>
                <span className="font-label-sm font-label-sm text-on-surface-variant">Hadir Tepat Waktu</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-sm bg-[#F59E0B]"></span>
                <span className="font-label-sm font-label-sm text-on-surface-variant">Terlambat</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-sm bg-tertiary-fixed-dim"></span>
                <span className="font-label-sm font-label-sm text-on-surface-variant">Izin/Sakit</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-sm bg-error"></span>
                <span className="font-label-sm font-label-sm text-on-surface-variant">Alpha</span>
              </div>
            </div>
          </div>

          <div className="relative w-full pt-4">
            <div className="absolute inset-0 flex flex-col justify-between pointer-events-none pb-8 text-on-surface-variant/40 font-label-sm font-label-sm">
            ...
            <div className="relative ml-9 h-56 flex items-end justify-between gap-1.5 sm:gap-3 overflow-x-auto pt-2 pb-8">
              {chartData.map((d) => (
                <div key={d.day} className={`group flex flex-col items-center flex-1 min-w-[28px] h-full justify-end ${d.weekend ? 'opacity-40' : ''} cursor-pointer`}>
                  ...
                  <span className={`absolute -bottom-1 font-label-sm font-label-sm ${d.weekend ? 'text-outline' : d.current ? 'font-body-sm-medium text-secondary' : 'group-hover:text-primary text-on-surface-variant'}`}>{d.day}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-space-sm pt-2">
            <div className="p-3.5 bg-surface-container rounded-lg flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-label-sm font-label-sm text-on-surface-variant">Total Jam Kerja</span>
                <span className="font-headline-sm font-headline-sm text-primary">{(totalHadir * 8).toLocaleString()} <span className="font-body-sm font-body-sm text-on-surface-variant font-normal">Jam</span></span>
              </div>
            </div>
            <div className="p-3.5 bg-surface-container rounded-lg flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-label-sm font-label-sm text-on-surface-variant">Rata-rata Keterlambatan</span>
                <span className="font-headline-sm font-headline-sm text-primary">{(totalTerlambat / Math.max(trendData.length, 1)).toFixed(1)} <span className="font-body-sm font-body-sm text-on-surface-variant font-normal">Menit / staf</span></span>
              </div>
            </div>
            <div className="p-3.5 bg-surface-container rounded-lg flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-label-sm font-label-sm text-on-surface-variant">Tingkat Kepatuhan Jadwal</span>
                <span className="font-headline-sm font-headline-sm text-primary">{kepatuhanJadwal}% <span className="font-body-sm font-body-sm text-[#16A34A] font-normal">+1.2%</span></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl p-space-lg shadow-sm flex flex-col gap-space-md">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-space-sm pb-1">
            <div className="flex flex-col">
              <h3 className="font-headline-sm font-headline-sm text-primary">Rincian Log Presensi Pegawai</h3>
              <span className="font-body-sm font-body-sm text-on-surface-variant">Menampilkan 1–{filteredTable.length} dari {totalCatatan} baris data log terkini</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="relative w-full sm:w-64">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-[18px]">search</span>
                <input
                  className="w-full h-9 pl-9 pr-3 bg-surface-container-low rounded-lg font-body-md font-body-md text-on-surface placeholder:text-outline focus:outline-none focus:bg-surface-container"
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left font-body-md font-body-md">
              <thead>
                <tr className="bg-surface-container-low text-on-surface-variant font-label-sm font-label-sm uppercase tracking-wider">
                  ...
                  <tr key={row.id} className="hover:bg-surface-container-low/50 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-full ${avatarStyles[idx] || 'bg-secondary-fixed text-on-secondary-fixed'} font-label-md font-label-md flex items-center justify-center flex-shrink-0`}>
                          {row.initials}
                        </div>
                        <div className="flex flex-col">
                          <span className="font-body-md-medium font-body-md-medium text-on-surface">{row.name}</span>
                          <span className="font-label-sm font-label-sm text-outline">{row.role}</span>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-3 font-mono font-body-sm font-body-sm-medium text-on-surface-variant">{row.niy}</td>
                    <td className="py-3 px-3">
                      <span className="px-2 py-0.5 rounded-full bg-surface-container text-on-surface-variant font-label-sm font-label-sm">{row.unit}</span>
                    </td>
                    ...
                    <td className="py-3 px-3">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full font-label-sm font-label-sm ${statusStyles[row.stMasukType]}`}>{row.stMasuk}</span>
                    </td>
                    <td className="py-3 px-3">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full font-label-sm font-label-sm ${statusStyles[row.stPulangType]}`}>{row.stPulang}</span>
                    </td>
                    <td className="py-3 px-4 font-body-sm font-body-sm text-on-surface-variant">{row.ket}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-space-sm pt-2">
            ...
            <div className="flex items-center gap-1.5">
              <button className="px-3 py-1.5 rounded-lg bg-surface-container-low text-outline cursor-not-allowed font-label-sm font-label-sm flex items-center gap-1" disabled type="button">
                <span className="material-symbols-outlined text-[16px]">chevron_left</span>
                <span>Sebelumnya</span>
              </button>
              <div className="flex items-center gap-1">
                <button className="w-8 h-8 rounded-lg bg-primary text-on-primary font-label-md font-label-md flex items-center justify-center cursor-pointer" type="button">1</button>
                <button className="w-8 h-8 rounded-lg bg-surface-container-low text-on-surface-variant hover:bg-surface-container font-label-md font-label-md flex items-center justify-center transition-colors cursor-pointer" type="button">2</button>
                <button className="w-8 h-8 rounded-lg bg-surface-container-low text-on-surface-variant hover:bg-surface-container font-label-md font-label-md flex items-center justify-center transition-colors cursor-pointer" type="button">3</button>
                <span className="px-1 text-outline">...</span>
                <button className="w-8 h-8 rounded-lg bg-surface-container-low text-on-surface-variant hover:bg-surface-container font-label-md font-label-md flex items-center justify-center transition-colors cursor-pointer" type="button">{totalHalaman}</button>
              </div>
              <button className="px-3 py-1.5 rounded-lg bg-surface-container-low text-on-surface hover:bg-surface-container font-label-md font-label-md flex items-center gap-1 transition-colors cursor-pointer" type="button">
