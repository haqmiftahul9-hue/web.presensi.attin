...
const initialFormData = {
  ...
  skYayasan: 'SK Kemenkumham No. AHU-00142.AH.01.04',
  emailSekretariat: 'sekretariat@raudhatuljannah.sch.id',
  alamatYayasan: 'Jl. Raya Cendekia No. 45, Kompleks Pendidikan Terpadu, Jakarta Selatan 12430',
...
function PengaturanGlobalPage() {
  ...
  const NotifToast = () => {
    ...
    return (
      <div
        className={`fixed top-4 right-4 ${colors[notification.type]} text-on-primary px-4 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2`}
      >
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="p-space-lg md:p-space-xl flex flex-col gap-space-lg max-w-[1600px] mx-auto w-full">
        ...
        <nav className="flex items-center gap-space-2xs text-on-surface-variant font-label-sm text-label-sm">
          ...
          <span className="material-symbols-outlined text-[14px]">chevron_right</span>
          <span className="text-secondary font-body-sm-medium">Pengaturan Global</span>
        </nav>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-space-sm">
          <div className="flex items-center gap-space-xs">
            ...
            <h1 className="font-headline-lg text-headline-lg text-on-surface tracking-tight">Pengaturan Global</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <form id="pengaturan-form" onSubmit={handleSave} className="space-y-6">
              <div className="bg-surface-container-lowest rounded-[12px] border border-outline-variant p-6 shadow-sm">
                ...
                <div className="border-b border-outline-variant pb-4 mb-6">
                  <h2 className="font-headline-sm text-headline-sm text-on-surface font-semibold">Identitas & Profil Yayasan</h2>
          ...
          {/* Right Column: Summary Cards (5 cols) */}
          <div className="lg:col-span-5 space-y-6">
            {/* Card Kebijikan Keamanan */}
            <div className="bg-surface-container-lowest rounded-[12px] border border-outline-variant p-5 shadow-sm">
              <div className="flex items-center justify-between pb-3 border-b border-outline-variant">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-on-surface">Kebihikan Keamanan</h3>
                </div>
            ...
            <div className="bg-surface-container-lowest rounded-[12px] border border-outline-variant p-5 shadow-sm">
              <div className="flex items-center justify-between pb-3 border-b border-outline-variant">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-on-surface">Default Sistem</h3>
                </div>
                <span className="font-label-sm text-label-sm text-on-surface-variant">Parameter Master</span>
              </div>
              <div className="py-4 space-y-3.5">
                {/* Two metric pills side by side */}
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-surface-container-low rounded-lg border border-outline-variant">
                    ...
                    <span className="font-headline-sm text-headline-sm text-on-surface mt-0.5 block">50 Meter</span>
                  ...
                  <div className="p-3 bg-surface-container-low rounded-lg border border-outline-variant">
                    ...
                    <span className="font-headline-sm text-headline-sm text-on-surface mt-0.5 block">15 Menit</span>
                    <span className="font-label-xs text-[10px] text-on-surface-variant/60">Sebelum status terlambat</span>
                  </div>
                </div>

                {/* Upcoming Holiday mini list */}
                <div>
