const units = [
  { name: 'TK / PAUD IT', present: 21, total: 22, percentage: 95.4 },
  { name: 'SD Islam RJ', present: 61, total: 65, percentage: 93.8 },
  { name: 'SMP Islam RJ', present: 47, total: 52, percentage: 90.3 },
  { name: 'SMA Islam RJ', present: 45, total: 50, percentage: 90.0 },
  { name: 'Sekretariat & Yayasan', present: 13, total: 14, percentage: 92.8 },
]
  ...
  return (
    <div className="bg-surface-container-lowest rounded-xl p-space-lg shadow-sm flex flex-col justify-between">
      <div className="flex items-center justify-between pb-space-sm">
        ...
        <span className="px-2 py-0.5 rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm">5 Unit Terdaftar</span>
      </div>
