        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-space-sm">
          <div className="flex items-center gap-space-sm">
            ...
            <div className="flex flex-col">
              <h1 className="font-headline-lg text-headline-lg text-on-surface tracking-tight">Manajemen Unit</h1>
        ...
        <div className="bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container-low/70 border-b border-outline/50 text-on-surface-variant font-label-sm text-label-sm uppercase tracking-wider">
                  <th className="py-3 px-4 font-label-sm">Nama Unit</th>
                  <th className="py-3 px-4 font-label-sm">Alamat Lengkap</th>
                  <th className="py-3 px-4 font-label-sm">Radius Presensi</th>
                  <th className="py-3 px-4 font-label-sm">Jam Operasional</th>
                  <th className="py-3 px-4 font-label-sm text-right">Pegawai</th>
                  <th className="py-3 px-4 font-label-sm text-center">Status</th>
                    ...
                    <tr key={unit.id} className="hover:bg-surface-container-low/50 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-lg bg-secondary-fixed text-on-secondary-fixed flex items-center justify-center font-label-md font-bold flex-shrink-0">
                            {iconKey}
                          </div>
                          <div className="flex flex-col">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-1.5 text-on-surface text-body-sm font-body-sm">
                      ...
                      <td className="py-3.5 px-4 text-center">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 text-label-sm font-label-sm">
                          Aktif
                        </span>
                      </td>
